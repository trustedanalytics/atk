 ...
 */
case class TAPAddToDataCatalogRequest(title: String,
                                      category: String,
                                      recordCount: Int,
                                      sourceUri: String,
                                      size: Int,
 ...
 */
case class ExportMetadata(title: String,
                           size: Int,
                           dataSample: String,
                           recordCount: Long,
                           isPublic: Boolean,
...
object ConvertExportMetadataToInputMetadataEntry {
  def convert(c: ExportMetadata, orgUUID: String) = {
    TAPAddToDataCatalogRequest(c.title, c.category, c.recordCount.toInt, c.sourceUri, c.size, orgUUID,
