 ...
 */
class LoopyBeliefPropagationEdgeInputFormat extends EdgeInputFormat[LongWritable, DoubleWritable] {
 ...
 */
class LoopyBeliefPropagationEdgeReader(config: LoopyBeliefPropagationConfiguration)
