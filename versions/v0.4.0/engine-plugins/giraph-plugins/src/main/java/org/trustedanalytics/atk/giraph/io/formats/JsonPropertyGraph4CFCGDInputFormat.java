...
/**
  ...
  * <code>VertexData4CGD</code> vertex values, and <code>EdgeData</code> edge
...
public class JsonPropertyGraph4CFCGDInputFormat extends TextVertexInputFormat<LongWritable,
    ...
    public TextVertexReader createVertexReader(InputSplit split, TaskAttemptContext context) {
        return new JsonPropertyGraph4CFCGDReader();
    }

    /**
     * VertexReader that features <code>VertexData4CGD</code> vertex values and
    ...
    class JsonPropertyGraph4CFCGDReader extends
        ...
        @Override
        protected VertexData4CGDWritable getValue(JSONArray jsonVertex) throws JSONException, IOException {
            ...
            return new VertexData4CGDWritable(vt, vector, vector.clone(), vector.clone());
        }
