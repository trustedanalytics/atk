...
DESCRIPTION="$SUMMARY "
day=$(date +"%Y%m%d")
REQUIRES=" java-1.7.0-openjdk, trustedanalytics-python-client >= ${version}-${day}${BUILD_NUMBER}, python-argparse, python-cm-api, postgresql-server, python27-cluster-config"
