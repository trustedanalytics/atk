...
export ATK_JARS="$ATK_LIB_DIR/module-loader-master-SNAPSHOT.jar:$ATK_LIB_DIR/scala-library-2.10.5.jar:$ATK_LIB_DIR/config-1.2.1.jar:$ATK_LIB_DIR/scala-reflect-2.10.5.jar:$ATK_LIB_DIR/logback-classic-1.1.1.jar:$ATK_LIB_DIR/logback-core-1.1.1.jar"
