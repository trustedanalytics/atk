...
class ARIMAScoreModelTest extends WordSpec {
  ...
  "ARIMAScoreModel" should {
    ...
    "throw an exception when data is passed in an invalid format" in {
      // ARIMA score model only expects an integer for the number of time periods, then an optional list of doubles
      intercept[IllegalArgumentException] {
        arimaScoreModel.score(Array[Any](5, 12.88969427, 13.54964408, 13.8432745, 12.13843611, 12.81156092, 14.2499628))
      }
      intercept[IllegalArgumentException] {
