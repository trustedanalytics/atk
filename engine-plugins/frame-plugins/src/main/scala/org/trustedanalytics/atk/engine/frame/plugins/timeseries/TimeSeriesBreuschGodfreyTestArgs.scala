...
case class TimeSeriesBreuschGodfreyTestArgs(@ArgDoc("Frame of time series data") frame: FrameReference,
                                            @ArgDoc("Name of the column that contains residual (y) values") residuals: String,
                                            @ArgDoc("Name of the column(s) that contain factors (x) values ") factors: List[String],
