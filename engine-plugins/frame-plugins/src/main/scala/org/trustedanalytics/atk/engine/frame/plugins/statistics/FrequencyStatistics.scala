...
private class FrequencyStatsAccumulatorParam[T](maxNumberOfModesReturned: Int)
  ...
  //  have rows lug around a container for ATK datatypes, not "Any" and then just have the comparators defined
  //  for all the subclasses of ATK datatypes.... but that might be a long way off
