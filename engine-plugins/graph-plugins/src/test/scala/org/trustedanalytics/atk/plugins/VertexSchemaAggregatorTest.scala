...
class VertexSchemaAggregatorTest extends WordSpec {
  ...
  val movieVertex = GBVertex(1L, Property("physicalId", 2L), Set(Property(GraphSchema.labelProperty, "movie"), Property("movieId", 23L)))
  val userVertex = GBVertex(2L, Property("physicalId", 3L), Set(Property(GraphSchema.labelProperty, "user"), Property("userId", 52L)))
