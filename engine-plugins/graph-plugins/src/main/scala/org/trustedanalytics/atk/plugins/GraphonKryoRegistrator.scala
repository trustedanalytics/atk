...
import org.trustedanalytics.atk.atkpregel.{ BasicCountsInitialReport, SuperStepNetDelta }
import org.trustedanalytics.atk.plugins.beliefpropagation.VertexState
