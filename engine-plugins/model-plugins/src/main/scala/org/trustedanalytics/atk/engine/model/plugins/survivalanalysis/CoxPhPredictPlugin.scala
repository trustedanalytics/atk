...
class CoxPhPredictPlugin extends SparkCommandPlugin[CoxPhPredictArgs, FrameReference] {
  /**
   ...
   */
  override def name: String = "model:cox_ph/predict"
   ...
   */
  override def execute(arguments: CoxPhPredictArgs)(implicit invocation: Invocation): FrameReference = {
    ...
    val coxData = coxJsObject.convertTo[CoxPhData]
