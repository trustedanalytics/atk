...
//   */
//  override def name: String = "model:linear_regression_with_sgd/new"
//
//  override def execute(arguments: GenericNewModelArgs)(implicit invocation: Invocation): ModelReference = {
//    engine.models.createModel(CreateEntityArgs(name = arguments.name, entityType = Some("model:linear_regression_with_s")))
//  }
//}
