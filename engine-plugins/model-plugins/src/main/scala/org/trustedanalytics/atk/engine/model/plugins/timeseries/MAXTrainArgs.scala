 ...
 */
case class MAXTrainArgs(model: ModelReference,
...
/**
 * Return object when training an MAXModel
 ...
 */
case class MAXTrainReturn(c: Double, ar: Array[Double], ma: Array[Double], xreg: Array[Double])
