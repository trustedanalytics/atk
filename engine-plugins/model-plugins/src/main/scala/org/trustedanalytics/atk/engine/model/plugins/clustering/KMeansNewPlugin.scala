...
This model runs MLLib's implementation of k-means[2]_ with enhanced features - computing the number of elements in each cluster during training and during predict
