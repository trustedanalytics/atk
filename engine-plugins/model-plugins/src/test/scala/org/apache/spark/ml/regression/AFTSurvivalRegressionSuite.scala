...
////import org.apache.spark.mllib.random.{WeibullGenerator, ExponentialGenerator}
...
//
//  test("params") {
//    ParamsSuite.checkParams(new Cox)
//    val model = new CoxModel("coxModel", Vectors.dense(0.0), Vectors.dense(0.0))
//    ParamsSuite.checkParams(model)
//  }
////}
//////
//////  test("cox: default params") {
//////    val cox = new Cox
//////    assert(cox.getLabelCol === "label")
//////    assert(cox.getFeaturesCol === "features")
//////    assert(cox.getPredictionCol === "prediction")
//////    assert(cox.getCensorCol === "censor")
//////    assert(cox.getFitIntercept)
//////    assert(cox.getMaxIter === 100)
//////    assert(cox.getTol === 1E-6)
//////    val model = cox.setQuantileProbabilities(Array(0.1, 0.8))
