...
scala_coverage_modules="engine/interfaces engine/meta-store engine/engine-core engine/graphbuilder engine-plugins/frame-plugins engine-plugins/graph-plugins engine-plugins/model-plugins engine-plugins/daal-plugins rest-server misc/launcher"
