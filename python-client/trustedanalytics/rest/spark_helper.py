...
from trustedanalytics.rest.spark import _wrap_row_function, get_copy_columns_function, IaBatchedSerializer, ifiltermap, _aggregate_wrap_rows_function
...
def agg_get_udf_arg(frame, subject_function, iteration_function, aggregation_schema, init_val, optional_schema=None):
    """
    Prepares a python row function for server execution and http transmission
    ...
    iteration_function: function
        ...
        imap.  For filter however, it is ifilter
    """
    row_ready_function = _aggregate_wrap_rows_function(frame, subject_function, aggregation_schema, init_val, optional_schema)
    def iterator_function(iterator): return iteration_function(row_ready_function, iterator)
    def iteration_ready_function(s, iterator): return iterator_function(iterator)
    x = make_http_ready(iteration_ready_function)
    return x
