...
class _BaseFrame(CommandLoadable):
    ...
    @api
    @arg('n', int, 'The number of rows to download to the client (if n > 10000, n will be truncated to 10000)')
...
<skip>
    ...
    @api
    @arg('n', int, 'The number of rows to print (if n > 10000, n will be truncated to 10000).')
    ...
    @api
    @arg('n', int, "The number of rows to copy to the client from the frame (if n > 10000, n will be truncated to 10000)")
