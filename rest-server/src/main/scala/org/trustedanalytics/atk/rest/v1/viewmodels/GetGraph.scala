 ...
 */
case class GetGraph(id: Long, atkUri: String, name: Option[String], links: List[RelLink], entityType: String, status: String) {
  require(id > 0, "id must be greater than zero")
  require(name != null, "name must not be null")
  require(links != null, "links must not be null")
  require(atkUri != null, "atk_uri must not be null")
