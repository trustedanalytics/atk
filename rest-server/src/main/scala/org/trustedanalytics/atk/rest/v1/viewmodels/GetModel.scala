 ...
 * @param ta_uri the ta_uri of the model
 * @param links hyperlinks to related URIs
 */

case class GetModel(id: Long, ta_uri: String, name: Option[String], links: List[RelLink], entityType: String, status: String) {
  require(id > 0, "id must be greater than zero")
  require(name != null, "name must not be null")
  require(links != null, "links must not be null")
  require(ta_uri != null, "ta_uri must not be null")
