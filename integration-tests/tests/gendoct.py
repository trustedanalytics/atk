...
model-daal_naive_bayes/new.rst
model-daal_naive_bayes/train.rst
model-daal_naive_bayes/predict.rst
model-daal_naive_bayes/test.rst
model-daal_naive_bayes/publish.rst
""".splitlines())
